...
: public fusion::JointUnaryVisitorBase<ComputeRNEADerivativesFasterForwardStep<Scalar, Options, JointCollectionTpl,
...
: public fusion::JointUnaryVisitorBase<ComputeRNEADerivativesFasterBackwardStep<Scalar, Options, JointCollectionTpl,
      MatrixType1, MatrixType2, MatrixType3>>
{
    typedef ModelTpl<Scalar, Options, JointCollectionTpl> Model;
    typedef DataTpl<Scalar, Options, JointCollectionTpl> Data;

    typedef boost::fusion::vector<const Model&, Data&, const MatrixType1&, const MatrixType2&, const MatrixType3&>
        ArgsType;

    template <typename JointModel>
    static void algo(const JointModelBase<JointModel>& jmodel, const Model& model, Data& data,
        const Eigen::MatrixBase<MatrixType1>& rnea_partial_dq, const Eigen::MatrixBase<MatrixType2>& rnea_partial_dv,
...
inline void computeRNEADerivativesFaster(const ModelTpl<Scalar, Options, JointCollectionTpl>& model,
    ...
    const Eigen::MatrixBase<MatrixType3>& rnea_partial_da)
{
    ...
    typedef ComputeRNEADerivativesFasterForwardStep<Scalar, Options, JointCollectionTpl, ConfigVectorType,
    ...
    typedef ComputeRNEADerivativesFasterBackwardStep<Scalar, Options, JointCollectionTpl, MatrixType1, MatrixType2,
        MatrixType3>
        Pass2;
    for (JointIndex i = (JointIndex)(model.njoints - 1); i > 0; --i) {
        Pass2::run(model.joints[i],
            typename Pass2::ArgsType(model, data, PINOCCHIO_EIGEN_CONST_CAST(MatrixType1, rnea_partial_dq),
