...
#ifndef __pinocchio_modaba_hpp__
#define __pinocchio_modaba_hpp__
...
namespace pinocchio
{
  ...
  /// \param[in] mu Input vector (dim model.nv).    
  /// \note This also overwrites data.f, possibly leaving it in an inconsistent state
  ///
  /// \return The current joint acceleration stored in data.ddq contracted with mu.
  ///
  ...
  PINOCCHIO_DEFINE_ALGO_CHECKER(modaba);
...
#endif // ifndef __pinocchio_modaba_hpp__
